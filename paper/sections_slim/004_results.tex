...
\todo[inline]{How do we square this with the big win going from "no personalization" to "static personalization?" And the statement in the results that it seems like the covariates tell us a lot about plasma concentration?}
