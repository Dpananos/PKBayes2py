...
\begin{document}
	\begin{titlepage}
	\maketitle
	\noindent \textbf{Corresponding author contact:} 
	
	\noindent Demetri Pananos \\ apananos@uwo.ca \\ 1151 Richmond St \\ London, ON, Canada \\ N6A 3K7
	
	\noindent \textbf{Social Media Content:}  Additional control in when and how many measurements are made can lead to better outcomes in personalized medicine.  However, additional control comes at a cost. We present a framework for assessing if the juice is worth the squeeze using Bayesian pharmacokientic models and dynamic treatment regimes in our latest paper!
	
	\noindent \textbf{Authors' twitter name:} @PhDemetri @danlizotte
	
	\noindent \textbf{preferred hashtags and organizational tags: }\#Statstwitter \#Bayesstats \#WesternUniversity
	
    \noindent \textbf{Word count:} 4496
	...
	\begin{titlepage}
		...
		%\vskip 1.5em
		Acknowledgements: The authors wish to thank Ava John-Baptiste for their comments on health economic impacts of this work, as well as Richard Kim and their lab for providing pharmacological expertise.
	\end{titlepage}
...
{\small \textbf{Highlights}: Bayesian pharmacokinetic models can enable personalized dosing strategies by making tailored predictions of drug concentration as a function of dose and patient characteristics. These models can also be updated with new measurements to adjust dose over time. We frame this process as a dynamic treatment regime, describe how Bayesian pharmacokinetic models can be used to estimate the optimal policy with Q learning, and propose a simulation-based strategy for internal evaluation. The proposed framework can help assess potential benefits of personalization to help decide whether it should be considered for further evaluation and deployment.
}
	...
	\newpage
	\bibliography{./bibs/introduction,./bibs/dtr, ./bibs/bayes, ./bibs/related_work}
	\newpage
	\appendix
